...
<div id="screenTrust" class="screen">
  ...
  <div class="text-container">
    ...
    <p>Your trust means the world to me 💖<br>
    I’ll always value it, no matter what 🌟</p>
...
function createFirework(){
  ...
  for(let i=0;i<30;i++){
    particles.push({x,y,r:random(1,3),dx:random(-3,3),dy:random(-8,-3),life:random(50,100),color});
  }
}
